...
class BuildTab(QWidget):
    def __init__(self):
        ...
        self.combo_opt.addItem("-Og (Debug/Default)", "-Og")
        self.combo_opt.addItem("-O0 (None)", "-O0")
        self.combo_opt.addItem("-O1 (Low)", "-O1")
        self.combo_opt.addItem("-O2 (High)", "-O2")
        self.combo_opt.addItem("-O3 (For Speed)", "-O3")
        self.combo_opt.addItem("-O3 (For Size)", "-O3 -fno-inline-functions -fno-unroll-loops")
        self.combo_opt.addItem("-Os (Size)", "-Os")
