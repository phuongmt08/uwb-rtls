...
class CommunicationTab(QWidget):
    ...
    def _build_tester_param_fields(self) -> None:
        ...
        self.f_antenna_delay_persist = QComboBox(self.tester_control_group)
        self.f_antenna_delay_persist.addItem("True", True)
        self.f_antenna_delay_persist.addItem("False", False)
        add("persist", "Persist to flash:", self.f_antenna_delay_persist)
        # log_data / log_clear
    ...
    _VISIBLE_FIELDS: dict[str, set[str]] = {
        ...
        "antenna_delay_bcast_set": {"serial_number", "tx_antenna_delay", "rx_antenna_delay", "persist"},
    ...
    def _collect_params(self, packet_name: str) -> dict:
        ...
        if packet_name == "time_sync_set":
            ...
            params["persist"] = bool(self.f_antenna_delay_persist.currentData())
