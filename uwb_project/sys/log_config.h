...
typedef enum {
	...
	LOG_OBJECT_CODE_USB_CDC = 0x06,
	LOG_OBJECT_CODE_SPI = 0x07,
	LOG_OBJECT_CODE_I2C = 0x08,
	LOG_OBJECT_CODE_USART = 0x09,
	LOG_OBJECT_CODE_TIMER = 0x0A,
	LOG_OBJECT_CODE_GPIO = 0x0B,
	LOG_OBJECT_CODE_DMA = 0x0C,
	LOG_OBJECT_CODE_FLASH = 0x0D,
	LOG_OBJECT_CODE_DELAY = 0x0E,
