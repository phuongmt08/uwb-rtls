...
#define TDMA_DEFAULT_GUARD_TIME_US   1000
/* ====================================================================
 * TIMING CONSTANTS
 * ==================================================================== */
...
#define TDMA_DEFAULT_POLL_TO_RESP_DELAY_US 2500   /* 2.5ms delay */
...
#define TDMA_DEFAULT_FINAL_TO_RESULT_DELAY_US 6000 /* NOTE: 6.0ms — Anchor slot 1 offset = 6000+3500 = 9500µs.
 ...
 * +------+ +-------------------+ +-------------------+ +-------+ +-------------------+ +---------------------+
 * | POLL | | (2.5ms default)   | | slots 1→N         | | FINAL | | (6.0ms default)   | | slots 1→N           |
 ...
 *
 *   => T_superframe(N) = 2500 + N*3000 + (2000 + 5000) + 6000 + N*3000 + 2000 (us)
 *                      = 17500 + 6000*N (us)
 *
 * Case N = 8 anchors (Maximum):
 *   T_active = 17500 + 6000*8 = 65500 us = 65.5 ms
 *
 * Case N = 6 anchors:
 *   T_active = 17500 + 6000*6 = 53500 us = 53.5 ms
 *
 * Case N = 4 anchors (Default):
 *   T_active = 17500 + 6000*4 = 41500 us = 41.5 ms
 *
 * Guard time notes:
