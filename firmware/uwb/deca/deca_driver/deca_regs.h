...
/* Compatibility aliases for deca_device.c */
#define CLEAR_ALLRXGOOD_EVENTS  SYS_STATUS_ALL_RX_GOOD
#define CLEAR_DBLBUFF_EVENTS    SYS_STATUS_ALL_DBLBUFF
#define CLEAR_ALLRXERROR_EVENTS SYS_STATUS_ALL_RX_ERR
#define CLEAR_ALLTX_EVENTS      SYS_STATUS_ALL_TX
...
#define GPIO_LNA_byte_no		GPIO_LNA_BYTE_NUM	/* Compatibility alias */
