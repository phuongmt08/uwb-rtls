...
#define NETWORK_CORE_PACKET_BUFFER_SIZE PROTOBUF_PROTOCOL_PB_H_MAX_SIZE
#define NETWORK_CORE_PACKET_WARN_SIZE ((uint32_t)protobuf_PROTOBUF_PACKET_WARN_BYTES)
